...
impl ByteWriter for ServerResponse {
    fn write_pkt(&self, out: &mut Vec<u8>) -> std::io::Result<()> {
        ...
        self.protocol_ver.write_pkt(&mut buf)?;
...
mod tests {
    ...
    fn fixtures() -> (Vec<u8>, ServerResponse) {
        let b = vec![
            0x86, 0x00, 0x01, 0x04, 0x03, 0x44, 0x4E, 0x07, 0x00, 0x48, 0xB3, 0xF9, 0xE4, 0xFD,
            0x0D, 0xF2, 0xA7, 0x2B, 0x5F, 0x44, 0xD3, 0xC8, 0xA2, 0xF4, 0xA0, 0x4D, 0x47, 0x03,
            0x05, 0x2E, 0x96, 0xB9, 0xAB, 0x2B, 0xEA, 0x68, 0x6B, 0xFF, 0x94, 0x96, 0x1A, 0xD4,
            0x33, 0xA7, 0x01, 0x32, 0x32, 0x33, 0x22, 0x31, 0x61, 0x80, 0xDA, 0x1B, 0xA6, 0x44,
            0x4A, 0x06, 0xCD, 0x17, 0xF8, 0xFA, 0x79, 0xD6, 0x0A, 0x63, 0xEC, 0x0A, 0x00, 0x63,
            ...
            protocol_ver: ProtocolVer::V4(
                ...
                V3Data {
                    game_date: DateTime::from_utc(
                        NaiveDateTime::from_timestamp(715875, 0),
                        Utc,
                    ),
